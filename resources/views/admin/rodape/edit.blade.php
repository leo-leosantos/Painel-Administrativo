        ...
        <div class="container-fluid">
            ...
            <div class="card card-primary">
                <div class="card-header">
                    <h3 class="card-title ">Alterar Frase  Dashboard</h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                    <!--card-body -->
                    <!--inicio do formulario create -->
                    <form action="{{ route('rodape.update', ['rodape' => $rodape->id]) }}" method="post">
                        @csrf
                        @method('PUT')
                        <section class="content">
                            <!--section textarea  -->
                                ...
                                <div class="col-12 col-sm-12">
                                    <div class="form-group">
                                        <label>Ativo</label>
                                                   ...
                                                   name="status" {{ (old('status') == 'on' || old('status') == true ? 'checked' : ($rodape->status == true ? 'checked' : '')) }}>
